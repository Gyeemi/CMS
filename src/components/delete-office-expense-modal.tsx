...
type DeleteOfficeExpenseModalProps = {
  visible: boolean;
  expenseLabel: string;
  onClose: () => void;
...
export function DeleteOfficeExpenseModal({
  visible,
  expenseLabel,
  onClose,
  onConfirm,
}: DeleteOfficeExpenseModalProps) {
          ...
          <ThemedView type="backgroundElement" style={[styles.panel, { borderColor: theme.border }]}>
            <ScrollView
              ...
              <ThemedText type="small" themeColor="textSecondary">
                ...
                <ThemedText type="smallBold">{expenseLabel || 'this expense'}</ThemedText>. This
                cannot be undone.
              </ThemedText>
              <ThemedText type="small" themeColor="textSecondary">
              ...
              <View style={styles.actions}>
                <PrimaryButton
                  label={submitting ? 'Removing…' : 'Remove Expense'}
                  variant="danger"
