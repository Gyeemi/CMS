-- Link a studio project to a registered client account (admin project form picker).
-- studio_registered_at is set in 20250606330000_studio_registered_notification.sql.
